...
namespace App\Http\Modulos\RepresentacionesGraficas\Documentos\etl_funzaxxx\rg899999433;
...
class Rg899999433_1 extends RgBase
{
    ...
    public function getPdf()
    {
        ...
        if ($cdo_tipo == "FC") {
            ...
            //Logos
            // $fpdf->Image($this->getFullImage('logo'.$ofe_identificacion.'.png'), $posx, $posy-1, 45);
            ...
            // Banco
            // logo
            // $fpdf->Image($this->getFullImage('logo'.$ofe_identificacion.'.png'), $posx, $posy+2, 22);
