...
namespace App\Http\Modulos\RepresentacionesGraficas\Documentos\etl_fusagaxx\rg890680008;
...
class Rg890680008_1 extends RgBase
{
    ...
    public function getPdf()
    {
        ...
        if ($cdo_tipo == "FC") {
            ...
            //Logos
            $fpdf->Image($this->getFullImage('logo'.$ofe_identificacion.'.png'), $posx, $posy-6, 23);
