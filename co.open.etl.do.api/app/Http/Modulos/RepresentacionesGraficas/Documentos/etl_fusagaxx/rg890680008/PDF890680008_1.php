...
class PDF890680008_1 extends PDFBase {
    ...
    function Header() {
        ...
        if ($this->datosComprobante['cdo_tipo'] != "FC") {
            ...
            //logo
            $this->Image($this->imageHeader, $posx-1, $posy, 17);
            ...
            $this->setXY($posx + 42, $posy + 11);
            $this->SetFont('Arial', 'B', 10);
            $this->MultiCell(110, 4, utf8_decode("PROCESOS FINANCIEROS\nNIT: " . $this->datosComprobante['ofe_nit']), 0, 'C');
