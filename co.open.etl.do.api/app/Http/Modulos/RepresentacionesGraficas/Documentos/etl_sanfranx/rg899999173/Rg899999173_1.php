...
namespace App\Http\Modulos\RepresentacionesGraficas\Documentos\etl_sanfranx\rg899999173;
...
class Rg899999173_1 extends RgBase
{
    ...
    public function getPdf()
    {
        ...
        if ($cdo_tipo == "FC") {
            ...
            //Logos
            // $fpdf->Image($this->getFullImage('logo'.$ofe_identificacion.'.png'), $posx, $posy-5, 20);
            $fpdf->Image($this->getFullImage('logo'.$ofe_identificacion.'_2.png'), $posx+22, $posy-3, 18);

            // resolucion
            $fpdf->setXY($posx+140, $posy+12);
            ...
            if($strCodigoBarras != "" && $strReferenciaPago != ""){
                ...
                $fpdf->setX($posx + 30);
                $fpdf->MultiCell(77,3.5," TEL: ".$ofe_tel,0,'C');
